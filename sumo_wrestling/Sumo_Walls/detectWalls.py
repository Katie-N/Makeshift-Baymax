...
class WallTracker(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            LaserScan,
            '/scan',  #topic for LiDAR sensor readings
            self.lidar_callback,
            10)
        """
    ...
    def lidar_callback(self, msg):
        ...
        left_dist = min(msg.ranges[60:120])   #left side (60° to 120°)
        right_dist = min(msg.ranges[240:300]) #right side (240° to 300°)
        front_dist = min(msg.ranges[0:20] + msg.ranges[340:360])  #front (0°-20° & 340°-360°)
